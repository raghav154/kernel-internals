...
void fun1() {
	...
	//pass_on_CPU(thread2); /* Commented out since its a round-robin scheduler */
    }
}
...
void fun2() {
	...
	//pass_on_CPU(thread3); /* Commented out since its a round-robin scheduler */
    }
}
...
void fun3() {
	...
	//pass_on_CPU(thread4); /* Commented out since its a round-robin scheduler */
    }
}
...
void fun4() {
	...
	//pass_on_CPU(thread1); /* Commented out since its a round-robin scheduler */
    }
}
...
int main() {
    ...
    SimpleTimer timer(20); /* timer ticks every 50ms = 20Hz */
    InterruptHandler::register_handler(0, &timer);
    /* The Timer is implemented as an interrupt handler for the round robin scheduling */
    ...
    /* Interrupts disabled initailly, since the threads have not yet been defined */
